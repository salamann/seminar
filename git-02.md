...
https://github.com/ を開いて、無料アカウントを作ってみましょう。
ユーザー名、Emailアドレス、パスワードを入力するだけで作れます。

[このページ](http://blog.glasses-factory.net/2011/04/14/github)に画像つきで説明があるので参考にしてください。

できたらアカウントをチャットで教えてください。

## clone してみる

適当な場所に練習用ディレクトリを新しく作り(下の例では git-work)、そこでリポジトリをクローンしてください。
$ はプロンプトのつもりで書いてますので、入力しないでくださいね。
